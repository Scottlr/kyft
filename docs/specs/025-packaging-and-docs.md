# 025 - Packaging And Docs

Finish the first usable package shape and examples.
...
- `dotnet build`, `dotnet test`, and `dotnet pack` succeed.
- README example compiles or is covered by a test.
